...
/// app bar, see [SliverAppBar], which embeds an [CustomAppBar] in a sliver for use in
/// a [CustomScrollView].
///
...
/// English):
///
/// The [CustomAppBar] insets its content based on the ambient [MediaQuery]'s padding,
/// to avoid system UI intrusions. It's taken care of by [Scaffold] when used in
/// the [Scaffold.appBar] property. When animating an [CustomAppBar], unexpected
/// [MediaQuery] changes (as is common in [Hero] animations) may cause the content
/// to suddenly jump. Wrap the [CustomAppBar] in a [MediaQuery] widget, and adjust its
...
///
/// If the [leading] widget is omitted, but the [CustomAppBar] is in a [Scaffold] with
...
///
/// {@tool dartpad}
/// This sample shows an [CustomAppBar] with two simple actions. The first action
...
/// {@tool dartpad}
/// This sample shows the creation of an [CustomAppBar] widget with the [shadowColor] and
...
///
/// {@tool dartpad}
/// This sample shows an [CustomAppBar] with two action buttons with their primary
...
/// See also:
///
///  * [Scaffold], which displays the [CustomAppBar] in its [Scaffold.appBar] slot.
///  * [SliverAppBar], which uses [CustomAppBar] to provide a flexible app bar that
///    can be used in a [CustomScrollView].
///  * [TabBar], which is typically placed in the [bottom] slot of the [CustomAppBar]
...
class CustomAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  CustomAppBar({
    ...
    this.title=const Text('Custom AppBar'),
    this.actions,
    this.flexibleSpace,
    this.bottom,
    this.elevation,
  ...
  /// Used by [Scaffold] to compute its [CustomAppBar]'s overall height. The returned value is
  /// the same `preferredSize.height` unless [CustomAppBar.toolbarHeight] was null and
  ...
  /// the app bar's [CustomAppBar.bottom] widget.
  ...
  /// [CustomAppBar] will imply an appropriate widget. For example, if the [CustomAppBar] is
  /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
  /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
  /// there's no [Drawer] and the parent [Navigator] can go back, the [CustomAppBar]
  ...
  /// See also:
  ///
  ///  * [Scaffold.appBar], in which an [CustomAppBar] is usually placed.
  ...
  ///
  /// A flexible space isn't actually flexible unless the [CustomAppBar]'s container
  /// changes the [CustomAppBar]'s size. A [SliverAppBar] in a [CustomScrollView]
  /// changes the [CustomAppBar]'s height when scrolled.
  ///
  ...
  /// null, then [CustomAppBar] uses the overall theme's [ColorScheme.primary] if the
  ...
  /// value is also null, then [CustomAppBar] uses the overall theme's
...
/// the screen see [CustomAppBar], which is used in the [Scaffold.appBar] slot.
///
...
///    scrolling.
///  * [CustomAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
///  * [TabBar], which is typically placed in the [bottom] slot of the [CustomAppBar]
///    if the screen has multiple pages arranged in tabs.
///  * [IconButton], which is used with [actions] to show buttons on the app bar.
///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
class SliverAppBar extends StatefulWidget {
  ...
  /// See also:
  ///
  ///   * [CustomAppBar], for a small or center-aligned top app bar.
  ...
  ///
  /// This property is used to configure an [CustomAppBar].
  final Widget? leading;
  ...
  /// content is not scrolled under the [CustomAppBar].
  ///
  /// Defaults to false, meaning that the [elevation] is only applied when the
  /// [CustomAppBar] is being displayed over content that is scrolled under it.
  ///
